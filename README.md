# mooapis [![CI](https://github.com/CowNetwork/mooapis/actions/workflows/ci.yaml/badge.svg?branch=main)](https://github.com/CowNetwork/mooapis/actions/workflows/ci.yaml)
